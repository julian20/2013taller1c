...
typedef enum {
	...
	EVENT_CANCEL_ATTACK, EVENT_WALKING, EVENT_STOP, EVENT_CONECT, EVENT_DISCONECT,
	EVENT_CAST_SPELL, EVENT_CANCEL_CAST , EVENT_EARTHQUAKE_START,EVENT_GOLEM, EVENT_NONE
}EventType;
